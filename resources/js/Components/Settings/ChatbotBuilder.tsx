...
const CustomMessageNode = ({ data }: any) => {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-indigo-500 shadow-lg w-64">
            <div className="bg-indigo-500 text-white px-3 py-2 rounded-t-lg flex items-center justify-between">
                ...
                <button title="Excluir Nó" aria-label="Excluir Nó" className="hover:bg-indigo-600 rounded p-0.5"><X className="h-3 w-3" /></button>
            </div>
            <div className="p-3 text-sm text-gray-700 dark:text-gray-300">
                <textarea title="Texto da Mensagem" aria-label="Texto da Mensagem" className="w-full text-sm rounded bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 p-2 resize-none focus:ring-1 focus:ring-indigo-500 min-h-[60px]" defaultValue={data.text} />
            </div>
...
const CustomMenuNode = ({ data }: any) => {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl border-2 border-emerald-500 shadow-lg w-64">
            <div className="bg-emerald-500 text-white px-3 py-2 rounded-t-lg flex items-center gap-2 font-semibold text-sm">
            ...
            <div className="p-2 space-y-2">
                ...
                <button className="w-full text-xs text-emerald-600 border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-900/30 rounded py-1 font-medium mt-1">
                    + Adicionar Opção
                </button>
            </div>
...
const initialNodes: Node[] = [
    ...
    },
    {
        ...
        data: { text: 'Olá! Bem-vindo à Elite Veículos. Como posso te ajudar hoje?' },
    },
    {
        id: '2',
        type: 'menuNode',
    ...
    },
    {
        ...
        data: { text: 'Ótimo! Vou te transferir para um de nossos corretores especialistas.' },
    }
];
        ...
        <div className="flex h-full w-full bg-slate-50 dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800">
            ...
            <div className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 flex flex-col shrink-0 z-10">
                ...
                <div className="space-y-3 flex-1">
                    <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center gap-3 cursor-grab hover:border-indigo-500 hover:shadow-sm bg-gray-50 dark:bg-gray-900 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all">
                        <MessageSquare className="h-5 w-5 text-indigo-500" />
                        Mensagem Simples
                    </div>
                    <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center gap-3 cursor-grab hover:border-emerald-500 hover:shadow-sm bg-gray-50 dark:bg-gray-900 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all">
                        <ListTree className="h-5 w-5 text-emerald-500" />
                        Menu Dinâmico
                    </div>
                    <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center gap-3 cursor-grab hover:border-blue-500 hover:shadow-sm bg-gray-50 dark:bg-gray-900 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all">
                        <ArrowRight className="h-5 w-5 text-blue-500" />
                        Transferir
                    </div>
                    <div className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg flex items-center gap-3 cursor-grab hover:border-purple-500 hover:shadow-sm bg-gray-50 dark:bg-gray-900 text-sm font-medium text-gray-700 dark:text-gray-300 transition-all">
